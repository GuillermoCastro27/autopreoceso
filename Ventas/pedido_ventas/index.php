        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registrar Pedidos de Ventas <small>CRUD de Pedidos y su detalle</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                <input type="hidden" value="0" id="txtOperacion"/>
                                <input type="hidden" value="" id="user_id"/>
                                <input type="hidden" value="PENDIENTE" id="ped_ven_estado"/>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="ped_ven_fecha" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="ped_ven_vence" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="ped_ven_observaciones" class="form-control" disabled>
                    ...
                    <div class="card" id="detalle" style="display:none">
                        <div class="header">
                            <h2>Detalles del Pedido de Ventas</h2>
                        </div>
                        <div class="body">
                    ...
                    <div class="card" id="registros">
                        <div class="header">
                            <h2>Registros de Pedidos de Ventas</h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
