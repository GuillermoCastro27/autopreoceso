        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Gestionar Ventas <small>CRUD de Ventas y su detalle</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                <input type="hidden" value="0" id="txtOperacion"/>
                                <input type="hidden" value="" id="user_id"/>
                                <input type="hidden" value="PENDIENTE" id="vent_estado"/>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="vent_intervalo_fecha_vence" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="vent_fecha" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="vent_cant_cuota" class="form-control" disabled>
                            ...
                            <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <!-- Campo de texto para la ciudad, habilitado -->
                                            <input type="text" id="pedido_venta" class="form-control" disabled onkeyup="buscarPedidoVentas();">
                                            <label class="form-label">Pedido de Ventas</label>
                                        </div>

                                        <!-- Campo oculto para almacenar el ID de la ciudad -->
                                        <input type="hidden" id="pedidos_ventas_id" name="pedidos_ventas_id" value="0">
