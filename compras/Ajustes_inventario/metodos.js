...
function listarDetalles(){
    ...
    .done(function(resultado){
        var lista = "";
        for(rs of resultado){
            lista = lista + "<tr class=\"item-list\" onclick=\"seleccionDetalle("+rs.item_id+",'"+rs.item_decripcion+"',"+rs.ajus_det_cantidad+","+rs.cantidad_stock+","+(rs.deposito_id||0)+");\">";
...
function seleccionDetalle(item_id, item_decripcion, ajus_det_cantidad, cantidad_stock, deposito_id) {
