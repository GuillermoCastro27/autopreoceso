...
<div class="card card-industrial">
    ...
    <div class="body">
        ...
        <input type="hidden" id="caja_estado" value="activo"/>
        ...
        <div class="section-box">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="caja_descripcion" class="form-control" disabled placeholder="Descripción">
                </div>
            </div>
        </div>
