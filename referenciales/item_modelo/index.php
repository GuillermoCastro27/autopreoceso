        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Item modelo <small>CRUD de Item modelo</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                            <input type="hidden" value="0" id="txtOperacion"/>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="item_modelo_descrip" class="form-control" disabled>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="hidden" id="modelo_id" value="0"/>
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registros de Items modelo</h2>
                        </div>
                        <div class="body">
