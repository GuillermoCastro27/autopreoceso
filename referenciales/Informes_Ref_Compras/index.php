...
<head>
    ...
    <title>Informes Referenciales de Compras</title>
...
<div class="card card-industrial">
    <div class="header" style="position:relative;">
        <h2>
            ...
            Informes Referenciales de Compras
            <small>Catálogos y tablas maestras del módulo de Compras</small>
        </h2>
    ...
    <div class="body">
        <div class="filtro-box no-print">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-2" id="wrap_tipo_filtro" style="display:none;">
                    <label>Tipo de modelo</label>
                    <input type="text" id="tipo_filtro" class="form-control" placeholder="Filtrar por tipo...">
                </div>
                <div class="col-sm-2">
                    <label>&nbsp;</label>
