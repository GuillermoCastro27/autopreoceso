...
<div class="card card-industrial">
    <div class="header">
        <h2>
            ...
            Mantener Nacionalidad
            <small>CRUD de Nacionalidad</small>
        </h2>
    </div>
    ...
    <div class="body">
        ...
        <input type="hidden" id="nacio_estado" value="activo"/>

        <!-- DATOS -->
        <div class="section-box">
            <div class="section-title">Datos de la Nacionalidad</div>
...
<div class="card card-industrial">
    <div class="header">
        <h2><i class="material-icons">list</i> Registros de Nacionalidad</h2>
    </div>
