...
<div class="card card-industrial">
    <div class="header">
        <h2>
            ...
            Tipo de Impuestos
            <small>CRUD de Tipo Impuestos</small>
        </h2>
    </div>
    ...
    <div class="body">
        ...
        <input type="hidden" id="tip_imp_estado" value="activo"/>

        <!-- DATOS -->
        <div class="section-box">
            <div class="section-title">Datos del Impuesto</div>
            <div class="row clearfix">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" id="tipo_imp_tasa" class="form-control" disabled placeholder="Tasa (%)">
                </div>
...
<div class="card card-industrial">
    <div class="header">
        <h2>
            ...
            Registros de Tipos de Impuestos
        </h2>
    </div>
