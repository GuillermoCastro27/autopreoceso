        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Tipo Descuentos <small>CRUD de Tipo Descuentos</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="tipo_desc_fechaInicio" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="tipo_desc_fechaFin" class="datetimepicker form-control" disabled>
                ...
                <div class="card">
                        <div class="header">
                            <h2>Registros de Tipo Descuentos</h2>
                        </div>
                        <div class="body">
