...
<head>
    ...
    <title>GUI EQUIPO DE TRABAJO</title>
...
<div class="card card-industrial">
    <div class="header">
        <h2>
            ...
            Mantener Equipo de Trabajo
            <small>CRUD de Equipo de Trabajo</small>
        </h2>
    </div>
    ...
    <div class="body">
        ...
        <input type="hidden" id="equipo_estado" value="activo"/>
        ...
        <div class="section-box">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" id="equipo_nombre" class="form-control" disabled placeholder="Nombre">
                </div>
...
<div class="card card-industrial">
    <div class="header">
        <h2><i class="material-icons">list</i> Registros de Equipos de Trabajo</h2>
    </div>
    <div class="body">
