...
<div class="card card-industrial">
    ...
    <div class="body">
        ...
        <input type="hidden" value="ACTIVO" id="ent_emis_estado"/>

        <!-- DATOS DE LA ENTIDAD -->
        <div class="section-box">
            <div class="section-title">Datos de la Entidad Emisora</div>
...
<div class="card card-industrial">
    <div class="header">
        <h2><i class="material-icons">list</i> Registros de Entidades Emisoras</h2>
    </div>
    <div class="body">
