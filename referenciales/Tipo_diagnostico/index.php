...
<head>
    ...
    <title>GUI TIPO DIAGNÓSTICO</title>
...
<div class="card card-industrial">
    <div class="header">
        <h2>
            ...
            Tipo de Diagnóstico
            <small>CRUD de Tipo Diagnóstico</small>
        </h2>
    </div>
    ...
    <div class="body">
        ...
        <input type="hidden" id="tipo_diag_estado" value="activo"/>
        ...
        <div class="section-box">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-5">
                    ...
                    <input type="text" id="tipo_diag_nombre" class="form-control" disabled placeholder="Nombre">
                </div>

                <div class="col-sm-5">
                    <label class="field-label">Descripción</label>
                    <input type="text" id="tipo_diag_descrip" class="form-control" disabled placeholder="Descripción">
                </div>
...
<div class="card card-industrial">
    <div class="header">
        <h2>
            ...
            Registros de Tipos de Diagnóstico
        </h2>
    </div>
