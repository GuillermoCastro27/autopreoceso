...
<div class="card card-industrial">
    <div class="header">
        <h2>
            ...
            Mantener Motivo de Ajuste
            <small>CRUD de Motivo de Ajuste</small>
        </h2>
    </div>
    ...
    <div class="body">
        ...
        <div class="section-box">
            <div class="section-title">Datos del Motivo</div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="descripcion" class="form-control" disabled placeholder="Descripción">
                </div>

                <div class="col-sm-4">
                    <label class="field-label">Tipo de Ajuste</label>
                    <select id="tipo_ajuste" class="form-control" disabled>
...
<div class="card card-industrial">
    <div class="header">
        <h2><i class="material-icons">list</i> Registros de Motivos de Ajuste</h2>
    </div>
