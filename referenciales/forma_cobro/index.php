...
<div class="card card-industrial">
    ...
    <div class="body">
        ...
        <div class="section-box">
            <div class="section-title">Datos de la Forma de Cobro</div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="for_cob_descripcion" class="form-control" disabled placeholder="Descripción">
                </div>
            </div>
        </div>
...
<div class="card card-industrial">
    <div class="header">
        <h2><i class="material-icons">list</i> Registros de Formas de Cobro</h2>
    </div>
