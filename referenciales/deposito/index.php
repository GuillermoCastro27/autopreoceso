...
<div class="card card-industrial">
    ...
    <div class="body">
        ...
        <input type="hidden" id="dep_estado" value="activo"/>

        <!-- DATOS DEL DEPÓSITO -->
        <div class="section-box">
            <div class="section-title">Datos del Depósito</div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-5">
                    <label class="field-label">Nombre del Depósito</label>
                    <input type="text" id="dep_nombre" class="form-control" disabled placeholder="Nombre del Depósito">
                </div>
...
<div class="card card-industrial">
    <div class="header">
        <h2><i class="material-icons">list</i> Registros de Depósitos</h2>
    </div>
