...
<div class="card card-industrial">
    ...
    <div class="body">
        ...
        <input type="hidden" id="pais_estado" value="activo"/>

        <!-- DATOS -->
        <div class="section-box">
            <div class="section-title">Datos del País</div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" id="txtDescripcion" class="form-control" disabled placeholder="Descripción">
                </div>

                <div class="col-sm-2">
                    <label class="field-label">Siglas</label>
                    <input type="text" id="txtSiglas" class="form-control" disabled placeholder="Siglas">
                </div>

                <div class="col-sm-3">
                    <label class="field-label">Nacionalidad (ej: Paraguayo/a)</label>
                    <input type="text" id="txtNacionalidad" class="form-control" disabled placeholder="Nacionalidad (ej: Paraguayo/a)">
                </div>
...
<div class="card card-industrial">
    <div class="header">
        <h2><i class="material-icons">list</i> Registros de Países</h2>
    </div>
