        ...
        <div class="section-box">
            ...
            <div class="row clearfix">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" id="pref_descripcion" class="form-control" disabled placeholder="Nombre">
                </div>
                <div class="col-sm-6">
                    <label class="field-label">Abreviatura</label>
                    <input type="text" id="pref_abreviatura" class="form-control" disabled placeholder="Abreviatura">
                </div>
            </div>
        </div>
