        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registrar Promociones <small>CRUD de Pormociones y su detalle</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                <input type="hidden" value="0" id="txtOperacion"/>
                                <input type="hidden" value="1" id="user_id"/>
                                <input type="hidden" value="PENDIENTE" id="prom_cab_estado"/>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="prom_cab_fecha_registro" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="prom_cab_fecha_inicio" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="prom_cab_fecha_fin" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="prom_cab_nombre" class="form-control" disabled>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="tipo_prom_nombre" class="form-control" disabled onkeyup="buscarTipoPromociones();">
                    ...
                    <div class="card" id="registros">
                        <div class="header">
                            <h2>Registros de Promociones</h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
