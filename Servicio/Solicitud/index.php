        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registrar Solicitudes de Servicio <small>CRUD de Solicitudes de servicio y su detalle</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                <input type="hidden" value="0" id="txtOperacion"/>
                                <input type="hidden" value="1" id="user_id"/>
                                <input type="hidden" value="PENDIENTE" id="soli_cab_estado"/>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="soli_cab_fecha" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="soli_cab_fecha_estimada" class="datetimepicker form-control" disabled>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="soli_cab_observaciones" class="form-control" disabled>
                        ...
                        <div class="body">
                            <div class="row clearfix" id="formDetalles">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="soli_det_cantidad_stock" class="form-control" disabled>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="soli_det_cantidad" class="form-control" disabled>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="soli_det_costo" class="form-control" disabled>
                    ...
                    <div class="card" id="registros">
                        <div class="header">
                            <h2>Registros de Solicitudes de Servicio</h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
